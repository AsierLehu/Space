...
public class Disparo {
    ...
    /** Reserva y devuelve el siguiente identificador numérico de proyectil para la partida. */
    ...
    public boolean disparar(int origenX, int origenY) {
        ...
        if (nuevoDisparo != null) {
            System.out.println("Anadiendo disparo a lista, id=" + nuevoDisparo.getDisparoId());
    ...
    /** Devuelve true si el componente a debe actualizarse antes que el b en el tick actual. */
    ...
    /** Menor coordenada X ocupada por el proyectil. */
