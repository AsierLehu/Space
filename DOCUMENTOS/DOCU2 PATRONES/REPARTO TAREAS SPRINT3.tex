...
\begin{enumerate}[leftmargin=2em]
    \item Implementar sistema de puntuación visible en pantalla — 5 horas
    \item Crear pantalla final mejorada (FinalFrame) con victoria/game over — 5 horas
    \item Implementar opción de reiniciar juego desde FinalFrame — 3 horas
    \item Añadir imágenes de fondo para todas las pantallas — 3 horas
    \item Crear estrategia de disparo doble (DisparoDoble) — 3 horas
    \item Crear cuarta nave jugable (Nave4) con disparo doble — 3 horas
\end{enumerate}

\textbf{Tiempo total estimado:} 22 horas.
...
\begin{enumerate}[leftmargin=2em]
    \item Implementar sistema de puntuación visible en pantalla — 7 horas
    \item Crear pantalla final mejorada (FinalFrame) con victoria/game over — 5 horas
    \item Implementar opción de reiniciar juego desde FinalFrame — 4 horas
    \item Añadir imágenes de fondo para todas las pantallas — 5 horas
    \item Crear estrategia de disparo doble (DisparoDoble) — 2 horas
    \item Crear cuarta nave jugable (Nave4) con disparo doble — 2 horas
\end{enumerate}

\textbf{Tiempo total real:} 25 horas.
...
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textbf{Tiempo real:}] 7 horas.
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Unai Urrutia — 3.5 horas
            \item Ekain Ortega — 1 hora
...
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textbf{Tiempo estimado:}] 3 horas.
    \item[\textbf{Tiempo real:}] 2 horas.
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Unai Urrutia — 1 horas
...
\begin{itemize}[leftmargin=2em]
    \item \textbf{Desviaciones significativas:} El tiempo real (25 horas) superó ligeramente la estimación (22 horas), principalmente en puntuación e imágenes de fondo por integración más compleja de lo previsto.
    \item \textbf{Problemas encontrados:} Inicialmente la puntuación no se actualizaba; se verificó el flujo de notificación de Espacio. Escalado de imágenes requirió ajustes de tamaño.
    \item \textbf{Lecciones aprendidas:} La integración con patrones existentes (MVC+Observer) requiere más tiempo que implementar componentes aislados. Las imágenes deben prepararse en el tamaño exacto.
    \item \textbf{Sugerencias para futuros proyectos:} Estimar el tiempo de integración como tarea separada. Preparar recursos visuales antes de comenzar desarrollo.
\end{itemize}
