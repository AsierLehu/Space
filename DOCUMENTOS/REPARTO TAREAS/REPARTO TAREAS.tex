...
\begin{enumerate}[leftmargin=2em]
    \item Diseño del juego Espacio (MVC) — 4 horas
    \item Pantallas StartFrame y MainFrame — 3 horas
    \item Vista y controlador y métodos update— 8 horas
    \item Implementación de la lógica de juego, disparo y colisiones — 3 horas
    \item Solución de errores en patrón MVC+Observer y el juego — 5 horas
    \item Documentación, diagramas ... — 5 horas
\end{enumerate}

\textbf{Tiempo total estimado:} 23 horas.
...
\begin{enumerate}[leftmargin=2em]
    ...
    \item Revisión y cambios para implementar correctamente el patrón MVC+Observer — 2.5 horas

    \item Documentación — 4 horas
    \item Diagramas UML y del patrón MVC+Observer — 3 horas
\end{enumerate}

\textbf{Tiempo total real:} 45.5 horas.
...
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Eder — 1 hora
            \item Ekain Ortega — 1.2 horas
            \item Unai Urrutia — 0.8 horas
            \item Asier López — 1 hora
        \end{itemize}
\end{description}
