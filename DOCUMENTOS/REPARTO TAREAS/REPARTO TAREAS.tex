...
\begin{enumerate}[leftmargin=2em]
    \item Diseño del modelo (MVC) — 2 horas
    \item Patrón Observer — 1 horas
    \item Vista y controlador — 2 horas
    \item Lógica de disparo y colisiones — 1 horas
    \item Movimiento de enemigos — 1 horas
    \item Gestión del juego (Main / bucle) — 2 horas
    \item Documentación — 3 horas
\end{enumerate}

\textbf{Tiempo total estimado:} 12 horas.
...
\begin{enumerate}[leftmargin=2em]
    \item Entendimiento del patrón MVC e ideamiento de las clases principales del juego — 3 horas
    \item Creación del repositorio y cambios para evitar problemas con archivos de configuración — 1 hora
    \item Desarrollo de las clases principales del modelo — 1.5 horas
    \item Desarrollo de la lógica de juego, disparo y colisiones — 1.5 horas
    \item Desarrollo de la vista, el controlador y los métodos update — 3 horas
    \item Solución de los métodos notify y update para inicializar MainFrame correctamente — 0.5 horas
    \item Solución de errores: colisiones, límites, movimiento — X horas
    \item Refinamiento del modelo — 1 hora
    \item Solución de estructura de MainFrame para implementarla con labels (Main / bucle) — 2 horas
    \item Reestructuración del update y notify para MainFrame, evitando que MainFrame tenga lógica de negocio — 2 horas
    \item Revisión y cambios para implementar correctamente el patrón MVC+Observer — 2 horas

    \item Documentación — 3 horas
    \item Diagramas UML y del patrón MVC+Observer — 2 horas
\end{enumerate}

\textbf{Tiempo total real:} 24.5 horas.
...
\begin{description}[leftmargin=2em, style=nextline]
    \item[\textbf{Descripción:}] Estudio del patrón MVC y Observer, diseño conceptual de las clases necesarias para el juego: \texttt{Espacio}, \texttt{Jugador}, \texttt{Enemigo}, \texttt{Naves}, \texttt{Disparo}, y planificación de la arquitectura general. Ademñas, pensamos y miramos en otras prácticas cómo se implementó el patrón MVC+Observer.
    
    \item[\textbf{Tiempo:}] 3 horas.
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Unai Urrutia — 1 horas
            \item Asier Lopez —  1 horas
            \item Eder Lorenzo — 0.5 horas
            \item Ekain Ortega — 0.5 horas

        \end{itemize}
    \item[\textbf{Problemas encontrados:}] Describir aquí los problemas encontrados durante el desarrollo de esta tarea.
\end{description}
...
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textbf{Tiempo:}] 1.5 horas.
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Unai Urrutia — 0.5 horas
            \item Asier Lopez — 0.5 horas
            \item Eder Lorenzo — 0.25 horas
...
% ---- Tarea 6 ----
\subsection*{Tarea 6 — Solución de los métodos notify y update para inicializar MainFrame}
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textbf{Tiempo:}] 0.5 horas.
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Unai Urrutia — 0.1 horas
            \item Asier Lopez — 0.3 horas
            \item Eder Lorenzo — 0.05 horas
            \item Ekain Ortega — 0.05 horas
...
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textbf{Tiempo:}] 2 horas.
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Unai Urrutia — 0.7 horas
            \item Asier Lopez — 0.7 horas
            \item Eder Lorenzo — 0.3 horas
            \item Ekain Ortega — 0.3 horas
