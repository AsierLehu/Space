...
\begin{enumerate}[leftmargin=2em]
    \item Diseño del modelo (MVC) — X horas
    \item Patrón Observer — X horas
    \item Vista y controlador — X horas
    \item Lógica de disparo y colisiones — X horas
    \item Movimiento de enemigos — X horas
    \item Gestión del juego (Main / bucle) — X horas
    \item Documentación — X horas
\end{enumerate}
...
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textbf{Responsables y dedicación:}]~
        \begin{itemize}[leftmargin=1em, nosep]
            \item Miembro 1 — X horas
            \item Miembro 2 — X horas
            \item Miembro 3 — X horas
        \end{itemize}
    \item[\textbf{Problemas encontrados:}] Describir aquí los problemas encontrados durante el desarrollo de esta tarea.
\end{description}
