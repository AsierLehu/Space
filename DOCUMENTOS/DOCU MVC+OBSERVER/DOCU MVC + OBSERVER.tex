...
En esta clase, su única función es detectar si el usuario pulsa la barra espaciadora, en tal caso llama a \lstinline|iniciarJuego()| que veremos posteriormente qué hace.
